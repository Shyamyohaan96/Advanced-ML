...
#################################################################
def deep_network_basic(n_inputs, n_hidden, n_output, activation, lrate, metrics):
    
    #sequential model
    model = Sequential();
    model.add(InputLayer(input_shape = (n_inputs,)))
    model.add(Dense(n_hidden[0], use_bias = True, name = "hidden_1", activation=activation))
    model.add(Dense(n_hidden[1], use_bias = True, name = "hidden_2", activation=activation))
    model.add(Dense(n_hidden[2], use_bias = True, name = "hidden_3", activation=activation))
    model.add(Dense(n_hidden[3], use_bias = True, name = "hidden_4", activation=activation))
    model.add(Dense(n_hidden[4], use_bias = True, name = "hidden_5", activation=activation))
    model.add(Dense(n_hidden[5], use_bias = True, name = "hidden_6", activation=activation))
