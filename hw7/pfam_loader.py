...
def load_pfam_file(basedir, fold, version='B'):
    '''
...
def load_pfam_dataset(basedir = '/home/fagg/datasets//pfam', rotation = 0, nfolds = 5, ntrain_folds = 3, version='B'):
    '''
...
def prepare_data_set(basedir = '/home/fagg/datasets/pfam', rotation = 0, nfolds = 5, ntrain_folds = 3, version='B'):
    '''
...
def save_data_sets(basedir = '/home/fagg/datasets/pfam', out_basedir = None, nfolds = 5, ntrain_folds = 3, version='B'):
    '''
